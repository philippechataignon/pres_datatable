...
Pour un jugement donné on peut avoir plusieurs infractions. La variable ``jgt_inf_ordre``
reflète la *gravité* de l'infraction, liée à l'encouru (ici 10 ans=3600 jours de prison).
